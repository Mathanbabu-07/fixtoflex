      ...
      <div className="flex items-center justify-between">
        ...
        {stage === "complete" && (
          <button
            ...
            className="px-4 py-2 bg-purple-50 text-[#7C3AED] rounded-xl text-xs font-bold hover:bg-purple-100 transition-all flex items-center gap-2 cursor-pointer"
          >
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                {stage === "queue_running" && queueStatus ? (
                  <div className={`px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 ${
                    ...
                    {queueStatus.github_status === 'Double Tick' ? '' : queueStatus.github_status}
                  </div>
                ) : (
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                {stage === "queue_running" && queueStatus ? (
                  <div className={`px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 ${
                    ...
                    {queueStatus.linkedin_status === 'Double Tick' ? '' : queueStatus.linkedin_status}
                  </div>
                ) : (
                  <div className="px-3 py-1 bg-purple-50 rounded-full text-xs font-bold text-[#7C3AED] flex items-center gap-1">
                    <Sparkles className="w-3 h-3" /> AI Ready
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                {stage === "queue_running" && queueStatus ? (
                  <div className={`px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 ${
                    ...
                    {queueStatus.portfolio_status === 'Double Tick' ? '' : queueStatus.portfolio_status}
                  </div>
                ) : (
                  <div className="px-3 py-1 bg-purple-50 rounded-full text-xs font-bold text-[#7C3AED] flex items-center gap-1">
                    <Sparkles className="w-3 h-3" /> AI Ready
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                {stage === "queue_running" && queueStatus ? (
                  <div className={`px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 ${
                    ...
                    {queueStatus.resume_status === 'Double Tick' ? '' : queueStatus.resume_status}
                  </div>
                ) : (
                  <div className="px-3 py-1 bg-purple-50 rounded-full text-xs font-bold text-[#7C3AED] flex items-center gap-1">
                    <Sparkles className="w-3 h-3" /> AI Ready
