  ...
  return (
    <motion.div
      ...
      transition={{ 
        ...
        y: { type: "tween", duration: 4, repeat: Infinity, ease: "easeInOut" }
      }}
      animate={{
        y: [0, -6, 0],
      }}
      // Combine base floating animation in the transition object
      // But we can let the parent motion.div handle it or use a nested layer.
      // Let's nest the floating and pulse layers for clean combined animation.
