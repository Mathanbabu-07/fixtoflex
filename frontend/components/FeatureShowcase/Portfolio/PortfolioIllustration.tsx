    ...
    <div className="scale-[0.7] xs:scale-[0.8] sm:scale-[0.85] md:scale-90 lg:scale-100 origin-center transition-all duration-500 w-full flex items-center justify-center overflow-visible">
      <div className="relative w-full aspect-[1.3/1] max-w-[660px] flex items-center justify-center select-none z-10 pt-6 pb-10 overflow-visible">
        ...
        >
          ...
          <div className="flex-1 flex flex-col overflow-hidden bg-white">
            ...
            <div className="flex items-center justify-between px-5 py-2 border-b border-slate-100/60">
              {/* Logo */}
              <div className="w-7 h-7 bg-linear-to-tr from-violet-600 to-indigo-600 rounded-lg flex items-center justify-center text-white font-extrabold text-[8px] shadow-sm">
                A
              </div>
              {/* Nav Items */}
              <div className="flex items-center gap-3 text-[8px] sm:text-[9px] font-semibold text-slate-500">
                ...
                <span className="px-2.5 py-1 bg-linear-to-r from-violet-600 to-indigo-600 text-white rounded-md text-[8px] font-bold cursor-pointer">
                  Hire Me
                </span>
              </div>
            </div>
            ...
            <div className="flex-1 flex items-center px-5 py-4 gap-5">
              ...
              <div className="flex-1 space-y-2.5 min-w-0">
                ...
                <div className="flex gap-2 pt-1">
                  <button className="px-3 py-1.5 bg-linear-to-r from-violet-600 to-indigo-600 text-white text-[8px] font-bold rounded-md shadow-sm">
                    View Work
                  </button>
                ...
                <div className="flex gap-2.5 pt-2">
                  ...
                  <div className="w-7 h-7 rounded-lg bg-linear-to-r from-violet-600 to-indigo-600 flex items-center justify-center text-white cursor-pointer">
              ...
              <div className="w-[130px] h-[140px] sm:w-[150px] sm:h-[160px] bg-linear-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-100/50 flex items-center justify-center shrink-0 overflow-hidden relative">
                <div className="absolute inset-0 bg-linear-to-tr from-purple-500/5 to-indigo-500/5" />
                {/* Stylized avatar */}
                <div className="flex flex-col items-center gap-1.5">
                  <div className="w-14 h-14 rounded-full bg-linear-to-br from-purple-300 to-indigo-400 flex items-center justify-center border-2 border-white shadow-md">
                    <User className="w-7 h-7 text-white" />
                  </div>
                  <div className="w-20 h-8 bg-linear-to-r from-indigo-200/60 to-purple-200/60 rounded-lg" />
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-white/40 rounded-2xl shadow-[0_10px_30px_rgba(124,58,237,0.1)] p-3.5 space-y-3">
            ...
            <div className="bg-slate-50 rounded-lg border border-slate-100 p-2 space-y-1.5">
              ...
              <div className="flex gap-1 mt-1.5">
                <div className="w-6 h-3 bg-linear-to-r from-violet-500 to-indigo-500 rounded-sm" />
        ...
        >
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative w-full h-2 bg-linear-to-r from-indigo-600 via-purple-500 to-violet-600 rounded-full">
        ...
        >
          <motion.div
            whileHover={{ y: -3 }}
            className="p-px rounded-2xl bg-linear-to-r from-purple-500 via-indigo-400 to-purple-500 bg-size-[200%_auto] animate-[shimmer_4s_linear_infinite] shadow-[0_10px_25px_rgba(124,58,237,0.12)] overflow-hidden"
          >
        ...
        >
          ...
          <div className="flex flex-col items-center mb-1">
            <div className="relative w-10 h-10 flex items-center justify-center mb-[-3px]">
              <div className="absolute w-5 h-5 bg-purple-400/80 rounded-tl-full rounded-br-full -rotate-45 origin-bottom-right bottom-0 right-1/2" />
              <div className="absolute w-5 h-5 bg-indigo-500/80 rounded-tr-full rounded-bl-full rotate-45 origin-bottom-left bottom-0 left-1/2" />
