...
interface PortfolioLeftContentProps {
  tabIndexStr?: string;
}

export default function PortfolioLeftContent({ tabIndexStr = "02 / 05" }: PortfolioLeftContentProps) {
  ...
  const featureList = [
    ...
    "Custom Domain & SEO Ready",
    "Mobile Responsive",
    "AI Suggestions for Better Impact"
  ];
  ...
  return (
    ...
    >
      ...
      >
        Create a stunning portfolio that showcases your work and wins opportunities.
      </motion.p>
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-slate-500 leading-normal font-medium">
              Our AI suggests the best sections, layout, and design to make your portfolio stand out.
            </p>
          </div>
        </div>
      </motion.div>
